...
Still utilizing the same tab as above, under `Deployed Contracts` select your deployed contract and click `helloWorld` this will call the `hellWorld` function within you `helloWorld.sol` smart contract.
